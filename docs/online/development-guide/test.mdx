...
Through the technical onboarding you will receive a sandbox test user. If you have not yet received one, please contact developer@vippsmobilepay.com to request a test user. The test user is assigned to your integration and not shared with others.
...
If you experience any issues with the test user, please contact developer@vippsmobilepay.com
