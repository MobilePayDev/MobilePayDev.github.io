...
We will continually send out information to all registered integrators about the new integration. As soon as we have more information on the documentation for the new version, we will update this page. 