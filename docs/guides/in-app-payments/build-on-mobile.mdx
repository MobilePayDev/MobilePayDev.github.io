...
This page details how MobilePay in-app payments should be implemented in your Android/iOS app.
...
- You already have backend services integrated with [MobilePay APIs](/docs/guides/in-app-payments/how-it-works).
...
- You already have backend services integrated with [MobilePay APIs](https://mobilepaydev.github.io/MobilePay-Payments-API/docs/guides/in-app-payments/how-it-works).
...
If you want maximum speed, consider checking this parameter and triggering a capture without checking payment's state in your backend (capture can only succeed if `status` returned value is `successful`).

P.S. This feature is **experimental**. Please let us know if it provides any value! 🙂
:::
