...
The other scenario is that MobilePay app tries to automatically navigate back to your app. For this to work you'll need:
...
In general case this deep link should open app screen which handles the "App switching" scenario described above and just treat it the same way as if the user manually navigated to your app.
