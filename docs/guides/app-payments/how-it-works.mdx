...
1. When a user wants to pay with MobilePay in your application, request your backend services to [create payment](/docs/payments-refunds/create-payments#create-payment) using Payments API.
